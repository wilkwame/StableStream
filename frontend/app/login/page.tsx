// app/auth/login/page.tsx (or wherever your login page is)
"use client";
...
export default function LoginPage() {
  ...
  const handleConnectWallet = async () => {
    ...
    try {
      ...
      // Call your auth context
      login(address, ensName || `${address.slice(0, 6)}...${address.slice(-4)}`);
    } catch (err: any) {
      console.error("Wallet connection failed:", err);
      alert(err.message || "Failed to connect wallet. Try again.");
    } finally {
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {/* Email Login (Optional - keep for now) */}
